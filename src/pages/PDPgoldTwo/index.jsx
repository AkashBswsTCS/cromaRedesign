        ...
        <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
          <div className="md:h-[199px] h-[70px] md:px-5 relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle758_70x1689.png"
              alt="rectangle758"
            />
          ...
          <div className="flex flex-col font-barlow mt-[3px] md:px-5 relative w-full">
            <div className="sm:h-[1013px] h-[1014px] md:h-[1412px] mx-auto w-full">
              <div className="absolute bottom-[10%] flex flex-row gap-[41px] items-center justify-center left-[11%] w-[22%]">
                <Button
              ...
              <div className="flex flex-col md:gap-10 gap-[108px] h-full justify-start ml-auto mr-[492px] my-auto w-[16%]">
                <div className="bg-blue_gray-100_26 blue_gray_200_black_900_00_border3 h-[254px] outline outline-[1px] rounded-[127px] w-[255px]"></div>
                <Img
                ...
                <div className="flex flex-col gap-[11px] justify-start mb-[95px] w-[95%] md:w-full">
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-1 flex-col md:gap-10 gap-[163px] justify-start ml-3 md:ml-[0] w-[24%] md:w-full">
                      ...
                      <div className="bg-blue_gray-100_26 blue_gray_200_02_black_900_00_border3 h-[218px] md:ml-[0] ml-[137px] outline outline-[1px] rounded-[109px] w-[219px]"></div>
                    </div>
                  </div>
                  <Img
