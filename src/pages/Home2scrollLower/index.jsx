    ...
    <>
      <div className="bg-gray-900_06 font-plusjakartasans h-[5590px] mx-auto relative w-full">
        <div className="absolute flex md:flex-col flex-row md:gap-10 h-full inset-[0] items-start justify-between m-auto overflow-auto w-full">
          <div className="h-[5590px] md:px-5 relative w-full">
            <div className="absolute h-[5590px] inset-y-[0] my-auto right-[0] w-[86%] md:w-full">
              <div className="h-[5590px] m-auto w-full">
                <div className="h-[5590px] m-auto w-full">
                  <div className="h-[5590px] m-auto w-full">
                    <Img
                      ...
                      alt="newgradientbgho"
                    />
                    <div className="absolute flex flex-col items-start justify-start left-[27%] pb-[236px] md:pr-10 sm:pr-5 pr-[236px] rounded-[28px] top-[2%] w-[23%]">
                      <Button className="cursor-pointer font-bold min-w-[116px] py-2.5 rounded-[21px] text-base text-center text-white-A700">
                        CATEGORY
                      </Button>
                    </div>
                  </div>
                  <div className="absolute flex flex-col inset-x-[0] justify-start mx-auto top-[17%] w-[94%]">
                    ...
                    <div className="flex h-[631px] md:h-[876px] justify-end md:ml-[0] ml-[1104px] mt-[249px] relative w-[30%] sm:w-full">
                      <Button
                    ...
                    <div className="flex flex-col md:gap-10 gap-60 items-start justify-start mr-2 mt-[793px] w-full">
                      <Text
                      ...
                      <div className="flex md:flex-col flex-row md:gap-10 items-center justify-between w-full">
                        <div className="bg-gray-900_70 flex md:flex-1 flex-col gap-[39px] justify-center p-6 sm:px-5 rounded-[35px] w-[24%] md:w-full">
                ...
                <div className="absolute bottom-[45%] flex flex-col justify-start left-[5%] w-[87%]">
                  <Button className="bg-gray-900 cursor-pointer font-bold min-w-[76px] md:ml-[0] ml-[822px] mr-[556px] py-2 rounded-[17px] text-[12.91px] text-center text-white-A700 tracking-[4.52px]">
                    NEW
                  </Button>
              ...
              <div className="absolute flex flex-col inset-x-[0] items-center justify-start mx-auto top-[2%] w-[90%]">
                <div className="flex md:flex-col flex-row md:gap-5 items-center justify-start w-full">
                  ...
                  <div className="flex md:flex-1 flex-col items-center justify-start md:ml-[0] ml-[369px] shadow-bs1 w-[8%] md:w-full">
                    <SelectBox
                  ...
                  <div className="h-[57px] ml-10 md:ml-[0] relative w-[57px]">
                    <Img
                  ...
                  <Img
                    className="common-pointer h-[57px] md:ml-[0] ml-[43px] w-[57px]"
                ...
                />
                <PagerIndicator
                  className="flex h-[7px] justify-center mt-[33px] w-[53px]"
                  count={3}
                ...
                />
                <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start mt-[141px] w-[99%] md:w-full">
                  <div className="flex flex-col md:gap-10 gap-[1786px] justify-start w-[32%] md:w-full">
                    <div className="flex flex-col md:gap-10 gap-[140px] items-start justify-start md:ml-[0] ml-[34px] w-[93%] md:w-full">
                    ...
                    <Line className="bg-white-A700 h-px mr-[254px] shadow-bs1 w-[47%]" />
                  </div>
                  <Button className="border border-gray-900_03 border-solid cursor-pointer font-semibold min-w-[247px] md:ml-[0] ml-[177px] md:mt-0 mt-[1083px] py-[21px] rounded-[11px] sm:text-[17.13px] md:text-[19.13px] text-[21.13px] text-center text-white-A700">
                    More Offers
                  </Button>
                  <Text
                    className="md:ml-[0] ml-[380px] md:mt-0 mt-[2084px] text-[18.78px] text-gray-500 text-shadow-ts tracking-[0.38px]"
                    size="txtPlusJakartaSansRomanSemiBold1878"
                  >
                    All best matches
                  </Text>
                  <Img
                    className="h-[29px] md:ml-[0] ml-[19px] md:mt-0 mt-[2084px] w-[29px]"
                    src="images/img_arrowright.svg"
                    alt="arrowright"
                  />
                </div>
              </div>
              <div className="absolute bottom-[10%] flex flex-col md:gap-10 gap-[142px] items-center justify-start left-[5%] w-[87%]">
                <div className="flex flex-col items-center justify-start shadow-bs1 w-full">
              ...
              <div className="absolute bg-gradient1  bottom-[34%] flex flex-col items-start justify-start p-[30px] sm:px-5 right-[0] w-[11%]">
            ...
            <div className="absolute flex flex-col inset-x-[0] justify-start mx-auto top-[2%] w-[52%]">
              <div className="flex flex-row sm:gap-10 items-start justify-between md:ml-[0] ml-[110px] w-[90%] md:w-full">
              ...
              <div className="flex sm:flex-col flex-row gap-[39px] items-start justify-end md:ml-[0] ml-[429px] mt-[538px] w-[42%] md:w-full">
                <Img
              ...
              <List
                className="sm:flex-col flex-row gap-[18px] grid md:grid-cols-1 grid-cols-2 mr-[54px] mt-[245px] w-[95%]"
            ...
            <div className="absolute bottom-[2%] flex flex-col md:gap-10 gap-[2468px] justify-start right-[5%] w-[76%]">
              <div className="h-[508px] relative w-[95%] md:w-full">
                <Slider
                  autoPlay
                  autoPlayInterval={2000}
              ...
              <div className="flex flex-col items-center justify-start ml-4 md:ml-[0] w-[99%] md:w-full">
            ...
            <div className="absolute flex md:h-[625px] h-[631px] justify-end left-[0] rounded-[23px] shadow-bs1 top-[24%] w-[24%] sm:w-full">
              <Button
                className="absolute bg-teal-A700 cursor-pointer flex items-center justify-center mb-[43px] min-w-[215px] ml-10 mt-auto px-[35px] py-[21px] rounded-[32px] shadow-bs3"
                rightIcon={
                  <div className="h-3 ml-[9px] w-3 bg-black-900 left-[2%] absolute my-1 inset-y-[1%]">
                    <Img
                      className="h-3 absolute"
                      src="images/img_upload.svg"
                      alt="upload"
              ...
              <div className="absolute border border-gray-900_05 border-solid md:h-[625px] h-[631px] inset-[0] justify-center m-auto sm:px-5 px-[23px] rounded-[23px] w-full">
                <div className="absolute flex flex-col h-max inset-[0] items-center justify-center m-auto w-[90%]">
                  <div className="flex flex-col gap-9 items-center justify-start w-full">
                    <Img
                      className="h-[282px] md:h-auto object-cover rounded-bl-[34px] rounded-br-[34px] w-full"
                      src="images/img_rectangle285.png"
                ...
                <div className="absolute bg-gradient1  flex flex-col h-full inset-y-[0] items-end justify-center my-auto p-9 sm:px-5 right-[4%] w-[39%]">
                  <div
                    className="common-pointer bg-white-A700 flex flex-col h-[100px] items-center justify-start my-[228px] p-[30px] sm:px-5 rotate-[-180deg] rounded-[50%] w-[100px]"
                    onClick={() => navigate("/")}
                  >
                    <Img
                      className="h-[37px] w-[37px]"
                      src="images/img_arrowright_37x37.svg"
...
export default Home2scrollLowerPage;
