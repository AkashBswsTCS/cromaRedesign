        ...
        <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
          <div className="md:h-[199px] h-[70px] md:px-5 relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle758_5.png"
              alt="rectangle758"
            />
          ...
          <div className="flex flex-col mt-[3px] md:px-5 relative w-full">
            <div className="h-[1014px] md:h-[1542px] mx-auto w-full">
              <div className="flex flex-col md:gap-10 gap-[108px] h-full justify-start ml-auto mr-[492px] my-auto w-[16%]">
                <div className="bg-blue_gray-100_26 blue_gray_200_black_900_00_border13 h-[254px] outline outline-[1px] rounded-[127px] w-[255px]"></div>
                <Img
              ...
              <div className="absolute bg-gradient4  flex flex-col h-full inset-[0] items-center justify-center m-auto p-8 sm:px-5 w-full">
                  ...
                  <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                    ...
                    <div className="flex md:flex-1 flex-col md:gap-10 gap-[159px] justify-start ml-3 md:ml-[0] w-[24%] md:w-full">
                      <div className="flex flex-row items-center justify-start mr-6 w-[94%] md:w-full">
                        ...
                        <Img
                          className="h-[57px] ml-[43px] w-[57px]"
                          src="images/img_group2755_gray_900_02_57x57.svg"
                          alt="group2755"
                        />
                      </div>
                      <div className="bg-blue_gray-100_26 blue_gray_200_02_black_900_00_border13 h-[222px] md:ml-[0] ml-[137px] outline outline-[1px] rounded-[111px] w-[223px]"></div>
                    </div>
                  </div>
