        ...
        <div className="absolute flex flex-col h-full inset-[0] items-center justify-center m-auto w-full">
          <div className="md:h-[199px] h-[70px] md:px-5 relative w-full">
            ...
            <Img
              ...
              src="images/img_rectangle758_2.png"
              alt="rectangle758"
            />
          ...
          <div className="flex flex-col mt-[3px] md:px-5 relative w-full">
            <div className="h-[1014px] sm:h-[867px] md:h-[893px] mx-auto w-full">
              <div className="flex flex-col md:gap-10 gap-[108px] h-full justify-start ml-auto mr-[492px] my-auto w-[16%]">
                <div className="bg-blue_gray-100_26 blue_gray_200_black_900_00_border7 h-[254px] outline outline-[1px] rounded-[127px] w-[255px]"></div>
                <Img
              ...
              <div className="absolute bg-gradient4  h-[1014px] sm:h-[867px] md:h-[893px] inset-[0] justify-center m-auto p-8 sm:px-5 w-full">
                <div className="sm:h-[867px] h-[877px] md:h-[893px] mx-auto w-[91%] md:w-full">
                  ...
                  <Img
                    className="absolute h-[57px] right-[1%] top-[0] w-[57px]"
                    src="images/img_group2755_gray_900_02.svg"
                    alt="group2755"
                  />
                  <div className="absolute bg-blue_gray-100_26 blue_gray_200_02_black_900_00_border7 h-[210px] outline outline-[1px] right-[0] rounded-[105px] top-[27%] w-[211px]"></div>
                </div>
