...
const PDPgoldWithCartItemPage = () => {
  const navigate = useNavigate();

  return (
    <>
      <div className="bg-black-900 font-inter h-[1586px] mx-auto relative w-full">
        <div className="absolute sm:h-[1581px] h-[1584px] md:h-[2454px] inset-[0] justify-center m-auto md:px-5 w-full">
          ...
          >
            <div className="flex flex-col justify-start mb-[17px] mt-[212px] w-[97%] md:w-full">
              <div className="bg-blue_gray-100_26 blue_gray_200_black_900_00_border12 h-[254px] md:ml-[0] ml-[802px] mr-[412px] outline outline-[1px] rounded-[127px] w-[255px]"></div>
              <Img
                className="h-[200px] md:h-auto md:ml-[0] ml-[845px] mt-[108px] object-cover w-[201px] sm:w-full"
                src="images/img_ellipse2.png"
                alt="ellipseTwo"
              />
              <div className="flex flex-row gap-[52px] items-center justify-start md:ml-[0] ml-[62px] mt-[82px] w-[23%] md:w-full">
              ...
              <div className="flex flex-col font-plusjakartasans items-center justify-start mt-[136px] w-full">
          ...
          <div className="absolute bg-gradient6  flex flex-col font-plusjakartasans inset-x-[0] items-center justify-start mx-auto p-8 sm:px-5 top-[5%] w-full">
            <div className="flex flex-col gap-[11px] justify-start mb-[95px] w-[95%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                ...
                <Img
                  ...
                  alt="eye"
                />
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[163px] justify-start ml-3 md:ml-[0] w-[24%] md:w-full">
                  <div className="flex flex-row items-center justify-start mr-5 w-[95%] md:w-full">
                  ...
                  <div className="bg-blue_gray-100_26 blue_gray_200_02_black_900_00_border12 h-[218px] md:ml-[0] ml-[137px] outline outline-[1px] rounded-[109px] w-[219px]"></div>
                </div>
              </div>
              <Img
        ...
        <div className="absolute bottom-[0] flex flex-col items-start justify-start pr-[181px] md:px-5 py-[181px] right-[0] rotate-[90deg] w-2/5">
          <Img
...
export default PDPgoldWithCartItemPage;
