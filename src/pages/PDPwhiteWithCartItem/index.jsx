...
const PDPwhiteWithCartItemPage = () => {
  ...
  return (
    <>
      <div className="bg-black-900 font-plusjakartasans h-[1586px] mx-auto relative w-full">
        <div className="absolute sm:h-[1581px] h-[1584px] md:h-[2454px] inset-[0] justify-center m-auto md:px-5 w-full">
          ...
          >
            <div className="flex flex-col justify-start mb-[17px] mt-[212px] w-[97%] md:w-full">
              <div className="bg-blue_gray-100_26 blue_gray_200_black_900_00_border14 h-[254px] md:ml-[0] ml-[802px] mr-[412px] outline outline-[1px] rounded-[127px] w-[255px]"></div>
              <Img
          ...
          <div className="absolute bg-gradient6  flex flex-col inset-x-[0] items-center justify-start mx-auto p-8 sm:px-5 top-[5%] w-full">
            <div className="flex flex-col gap-[11px] justify-start mb-[72px] w-[95%] md:w-full">
              <div className="flex md:flex-col flex-row md:gap-5 items-start justify-start w-full">
                <div className="sm:h-[758px] h-[759px] md:h-[784px] md:mt-0 mt-2 relative w-[70%] md:w-full">
                ...
                <Img
                  ...
                  alt="eye"
                />
                <div className="flex md:flex-1 flex-col md:gap-10 gap-[159px] justify-start ml-3 md:ml-[0] w-[24%] md:w-full">
                  <div className="flex flex-row items-center justify-start mr-6 w-[94%] md:w-full">
                    <div className="flex flex-col items-center justify-start shadow-bs1 w-[35%] sm:w-full">
                      <SelectBox
                    ...
                    <div className="h-[57px] ml-10 relative w-[57px]">
                      <Img
                    ...
                    <Img
                      className="common-pointer h-[57px] ml-[43px] w-[57px]"
                      src="images/img_group2755_gray_900_02_57x57.svg"
                      alt="group2755"
                      onClick={() => navigate("/cart")}
                    />
                  </div>
                  <div className="bg-blue_gray-100_26 blue_gray_200_02_black_900_00_border14 h-[222px] md:ml-[0] ml-[137px] outline outline-[1px] rounded-[111px] w-[223px]"></div>
                </div>
              </div>
              <div className="flex md:flex-col flex-row font-inter md:gap-5 items-start justify-end md:ml-[0] ml-[138px] w-[88%] md:w-full">
                <CARTStepper className="h-10 md:mt-0 mt-[54px] relative w-[120px]" />
                <div className="flex flex-col font-barlow items-center justify-start md:ml-[0] ml-[51px] md:mt-0 mt-[51px] rounded-[20px] shadow-bs14 w-[13%] md:w-full">
                ...
                <Img
                  className="h-[75px] md:h-auto mb-[23px] md:ml-[0] ml-[371px] object-cover"
        ...
        <div className="absolute bottom-[0] flex flex-col items-start justify-start pr-[183px] md:px-5 py-[183px] right-[0] rotate-[180deg] w-2/5">
          <Img
...
export default PDPwhiteWithCartItemPage;
